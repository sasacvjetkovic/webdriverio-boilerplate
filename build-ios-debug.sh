...
echo 'Build .app'
xcodebuild -workspace "reactDemo.xcworkspace" -scheme "reactDemo" -configuration "Debug" -destination "platform=iOS Simulator,OS=$OS,id=$DEVICE_UUID" -derivedDataPath $BUILD_PATH

echo 'Copy generated .app file into project structure'
cp -R $BUILD_PATH'/Build/Products/Debug-iphonesimulator/reactDemo.app' ../$APP_PATH
